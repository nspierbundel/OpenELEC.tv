...
def check_login(source,username):
    ...
    logged_in_string = 'Limited support in chat, please use the forum for other support'
...
def doLogin(cookiepath, username, password):
    ...
    if username and password:
        ...
        login_url = 'http://totalxbmc.tv/new-forum/index.php?action=login2'

        #the header used to pretend you are a browser
        header_string = 'LetMeIn its the xbmc addon'

	#build the form data necessary for the login
        login_data = urllib.urlencode({'user':username, 'passwrd':password, 'cookielength':'60', '&hash_passwrd':'c5906827d4caa54112367e4560084506f830da2c'})
