...
TempPath=os.path.join(datapaths,'Temp')
...
def CATEGORIES():
    ...
    main.addDir('Manage Downloads','none','viewQueue','http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/512/Sidebar-Downloads-1-icon.png',fanart,'','','')
    main.addDir('Search','ss','searchall','http://icons.iconarchive.com/icons/treetog/i/256/Search-icon.png',fanart,'','','') 
    main.AUTO_VIEW('menu')    
...
#SEARCH FUNCTIONS#
    ...
    from searchit import supersearch 
    print ""+url
