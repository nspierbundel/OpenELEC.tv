...
if not os.path.exists(InitialFilePath):
    ...
    if not os.path.exists(os.path.join(xbmc.translatePath(ROOT), '.TLBB Plugins',FILENAME)):
        ...
        f.write("<favourite name='TLBB Updater' thumb='special://home/addons/script.tlbb/icon.png'>RunScript(special://home/addons/skin.tlbb/extras/scripts/update.py)</favourite>\n")
